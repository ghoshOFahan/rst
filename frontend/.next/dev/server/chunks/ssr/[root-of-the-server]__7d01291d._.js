...
function GameRoom() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // 1. If GameState is missing (Refresh), go to Home
        if (!gameState) {
            router.push("/");
        }
        // 2. Cleanup Function: triggers on Refresh, Tab Close, or Component Unmount
        return ()=>{
            socket?.emit("leaveRoom"); // <-- This prevents the "Ghost Player" issue
        };
    }, [
        gameState,
        router
...
function RoomPage() {
    ...
    const currentPlayer = gameState.players.find((p)=>p.id === __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$socket$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d01291d._.js.map