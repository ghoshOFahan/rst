...
function RoomPage() {
        ...
        "RoomPage.useEffect": ()=>{
            ...
            if (!gameState && lastRoomId) {
                __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].emit("reconnectRoom", {
                    roomId: lastRoomId,
                    clientId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$page$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientId"])()
                });
            }
        }
    }["RoomPage.useEffect"], [
    ...
    const currentPlayer = gameState.players.find((p)=>p.clientId === (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$page$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientId"])());
    const isEliminated = currentPlayer?.isEliminated;
    switch(gameState.status){
        case "LOBBY":
...
//# sourceMappingURL=_83cb6cac._.js.map